...
void loop() {
  ...
  colorWipe(strip.Color(255, 255, 0), 50);//黄色
  colorWipe(strip.Color(0, 255, 255), 50);//ブルー
  colorWipe(strip.Color(255, 0, 255), 50); // ピンク
  // Send a theater pixel chase in...
  theaterChase(strip.Color(127, 127, 127), 50); // 白
  theaterChase(strip.Color(  0,   127, 127), 50); // 青
  theaterChase(strip.Color(127,   0,   127), 50); // 赤

 }
///////////////////////ここまでがloop関数///////////////////////////////////

//光り方の関数1 colorWipe ここから
